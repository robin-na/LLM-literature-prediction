...
% IDE-style code block for CLI commands
\lstdefinestyle{clibox}{
  ...
  aboveskip=6pt,
  belowskip=6pt,
  postbreak=\mbox{\textcolor{black!40}{$\hookrightarrow$}\space},
}
...
% Allow \texttt field names to break at underscores within table columns
