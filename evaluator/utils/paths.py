...
HUMAN_IN_SAMPLE_CSV: Path = resolve_input_dataset_path(HUMAN_INPUT_DIR, "human_in_sample")
HUMAN_OUT_OF_SAMPLE_CSV: Path = resolve_input_dataset_path(HUMAN_INPUT_DIR, "human_out_of_sample")
# Back-compat: existing consumers expect HUMAN_DATASET_CSV. Points at the
# in-sample dataset (which has been used for prompt development).
HUMAN_DATASET_CSV: Path = HUMAN_IN_SAMPLE_CSV
